 ...
 */
final class Version20221026085032 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE personnage (id INT AUTO_INCREMENT NOT NULL, user_personnage_id INT NOT NULL, wallet_id INT NOT NULL, talent_id INT DEFAULT NULL, serveur INT NOT NULL, name VARCHAR(255) NOT NULL, level INT NOT NULL, current_xp INT NOT NULL, total_xp INT NOT NULL, current_lp INT NOT NULL, total_lp INT NOT NULL, current_pm INT NOT NULL, total_pm INT NOT NULL, physical_atk INT NOT NULL, magical_atk INT NOT NULL, physical_def INT NOT NULL, magical_def INT NOT NULL, agility INT NOT NULL, vitality INT NOT NULL, stat_point INT NOT NULL, INDEX IDX_6AEA486DB0BFFE12 (user_personnage_id), UNIQUE INDEX UNIQ_6AEA486D712520F3 (wallet_id), INDEX IDX_6AEA486D18777CEF (talent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_race (id INT AUTO_INCREMENT NOT NULL, racial_advantage_id INT NOT NULL, personnage_id INT DEFAULT NULL, url_img LONGTEXT NOT NULL, name_race_fr VARCHAR(255) NOT NULL, name_race_en VARCHAR(255) NOT NULL, description_fr LONGTEXT NOT NULL, description_en LONGTEXT NOT NULL, INDEX IDX_A0EEF7662A087264 (racial_advantage_id), UNIQUE INDEX UNIQ_A0EEF7665E315342 (personnage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
